main = {
  project_id           = "customersegment-t-4ca6"
  region               = "europe-west1"
  zone                 = "europe-west1-c"
  env                  = "test"
  ...
  srv_read_access_grp  = "customersegment-t-4ca6.customersegment_srv-readers-d0b2@gmail.com"
  branch_name          = "integration"
  dbt_target           = "integration"
  dbt_environment_id   = 6530
  dbt_project_id       = 3559
  dbt_cloud_host_url   = "https://emea.dbt.com/api"
  dbt_cloud_account_id = 68
  service_account      = "project-service-account@customersegment-t-4ca6.iam.gserviceaccount.com"
}
...
notification_channel = {
  devloper_channel = {
    ...
    email_address = "karanrmapal87@gmail.com"
  }
}
